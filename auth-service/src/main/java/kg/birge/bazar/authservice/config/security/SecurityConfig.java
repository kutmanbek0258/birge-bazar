package kg.birge.bazar.authservice.config.security;

import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.DeserializationContext;
import com.fasterxml.jackson.databind.JsonDeserializer;
import jakarta.annotation.PostConstruct;
import kg.birge.bazar.authservice.config.SecurityProperties;
import kg.birge.bazar.authservice.config.filter.XSSFilter;
import kg.birge.bazar.authservice.config.security.handler.CustomAuthenticationSuccessHandler;
import kg.birge.bazar.authservice.config.security.handler.CustomOauthAuthenticationSuccessHandler;
import kg.birge.bazar.authservice.config.security.properties.AuthorizationServerProperties;
import kg.birge.bazar.authservice.service.UserEventService;
import kg.birge.bazar.authservice.service.impl.CustomOAuth2UserService;
import kg.birge.bazar.authservice.service.impl.CustomUserDetailsService;
