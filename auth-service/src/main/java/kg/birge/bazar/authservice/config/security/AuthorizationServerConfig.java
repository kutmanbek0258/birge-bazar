...
import kg.birge.bazar.authservice.config.security.granttype.password.OAuth2PasswordAuthenticationConverter;
import kg.birge.bazar.authservice.config.security.granttype.password.OAuth2PasswordTokenAuthenticationProvider;
import kg.birge.bazar.authservice.config.security.properties.AuthorizationServerProperties;
import kg.birge.bazar.authservice.service.security.IntrospectionService;
...
import static kg.birge.bazar.authservice.config.security.SecurityConfig.LOGIN_PAGE;
