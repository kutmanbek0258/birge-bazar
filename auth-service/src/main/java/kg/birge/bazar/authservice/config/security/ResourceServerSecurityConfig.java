...
import kg.birge.bazar.authservice.config.security.introspector.CustomSpringTokenIntrospection;
import kg.birge.bazar.authservice.config.security.properties.OAuth2ResourceOpaqueProperties;
